...
!function (a) {
  ...
  !function (c) {
    ...
    } else document.attachEvent && (l = c, i = a.document, o = !1, (_n = function n() {
      try {
    ...
    var c, t, e, l, i, o;
    (c = document.createElement("div")).innerHTML = n, n = null, (t = c.getElementsByTagName("svg")[0]) && (t.setAttribute("aria-hidden", "true"), t.style.position = "absolute", t.style.width = 0, t.style.height = 0, t.style.overflow = "hidden", e = t, (l = document.body).firstChild ? (i = e, (o = l.firstChild).parentNode.insertBefore(i, o)) : l.appendChild(e));
  });
}(window);
